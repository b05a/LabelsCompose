package com.example.labels.ViewModel
...
//    var listHeightLabel = mutableStateListOf<HeightLabel>()
    ...
    init {
//        listLabels.add(Label(null,"vertical", 100,50,true))
//        listLabels.add(Label(null,"horizontal", 50,100,false))
        viewModelScope.launch(Dispatchers.IO) {
            // получаем цвет меток из бд
            colorLabel = db.getColorLabel()

            listLabels = db.getListLabel()
//            listHeightLabel = db.getListHeightLabel()
        }
    }
